...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menu_tw.setGeometry(QRect(20, 0, 1011, 721))
        ...
        self.table_tv.setGeometry(QRect(20, 100, 971, 531))
        ...
        self.tabWidget_2.setGeometry(QRect(10, 40, 971, 611))
        ...
        self.equipe_tv.setGeometry(QRect(20, 10, 931, 551))
        ...
        self.admin_site_tab.setGeometry(QRect(10, 0, 971, 671))
        self.tab_4 = QWidget()
        self.tab_4.setObjectName(u"tab_4")
        self.gridLayoutWidget = QWidget(self.tab_4)
        self.gridLayoutWidget.setObjectName(u"gridLayoutWidget")
        self.gridLayoutWidget.setGeometry(QRect(60, 20, 831, 411))
        ...
        self.match_admin_tv = QTableView(self.tab_5)
        self.match_admin_tv.setObjectName(u"match_admin_tv")
        self.match_admin_tv.setGeometry(QRect(20, 80, 911, 431))
        ...
        self.match_edit_btn.setGeometry(QRect(590, 570, 80, 24))
        self.nbreSpectateurs_le = QLineEdit(self.tab_5)
        self.nbreSpectateurs_le.setObjectName(u"nbreSpectateurs_le")
        self.nbreSpectateurs_le.setEnabled(False)
        self.nbreSpectateurs_le.setGeometry(QRect(440, 570, 141, 24))
        self.nbreButsA_le = QLineEdit(self.tab_5)
        self.nbreButsA_le.setObjectName(u"nbreButsA_le")
        self.nbreButsA_le.setEnabled(False)
        self.nbreButsA_le.setGeometry(QRect(220, 570, 91, 24))
        self.nbreButsB_le = QLineEdit(self.tab_5)
        self.nbreButsB_le.setObjectName(u"nbreButsB_le")
        self.nbreButsB_le.setEnabled(False)
        self.nbreButsB_le.setGeometry(QRect(330, 570, 91, 24))
        self.label = QLabel(self.tab_5)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(220, 550, 81, 16))
        self.label_2 = QLabel(self.tab_5)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(330, 550, 91, 16))
        self.label_3 = QLabel(self.tab_5)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(440, 550, 141, 16))
        self.refresh_match_btn = QPushButton(self.tab_5)
        self.refresh_match_btn.setObjectName(u"refresh_match_btn")
        self.refresh_match_btn.setGeometry(QRect(40, 30, 80, 24))
        ...
        self.menu_tw.setCurrentIndex(2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.nbreSpectateurs_le.setText("")
        self.nbreButsA_le.setText("")
        self.nbreButsB_le.setText("")
        self.label.setText(QCoreApplication.translate("MainWindow", u"Nbr buts ClubA", None))
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"Nbr buts ClubB", None))
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"Nombre de Spectateurs", None))
        self.refresh_match_btn.setText(QCoreApplication.translate("MainWindow", u"Rafra\u00eechir", None))
